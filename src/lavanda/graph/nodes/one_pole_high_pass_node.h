#ifndef LAVANDA_GRAPH_NODES_ONE_POLE_HIGH_PASS_NODE_H_
#define LAVANDA_GRAPH_NODES_ONE_POLE_HIGH_PASS_NODE_H_
...
class OnePoleHighPassNode final : public AudioNode {
 public:
  explicit OnePoleHighPassNode(std::uint32_t channel_count) noexcept
 ...
 private:
  ...
  std::array<float, kMaxChannels> previous_input_{};
